...
// 								className="btn text-base-200 btn-circle transition-transform hover:scale-110">
...
// 												{themeOption === "light" && <i className="bi bi-sun text-lg"></i>}
// 												{themeOption === "dark" && <i className="bi bi-moon text-lg"></i>}
// 												{themeOption === "system" && <i className="bi bi-laptop text-lg"></i>}
